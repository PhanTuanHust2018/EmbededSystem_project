...
//#define GPIO_BASE  (0x7e000000 + GPIO_OFFSET)
...
int gpio_init(void)
{
    ...
    DEBUG_OUT("virtual select :%d",gpio_function_select);
    gpio_pin_output_set = (u32*)ioremap(0xFE20001c,GPIO_SIZE);
    DEBUG_OUT("virtual set :%d",gpio_pin_output_set);
    gpio_pin_output_clear = (u32*)ioremap(0xFE200028,GPIO_SIZE);
    gpio_pin_level = (u32*)ioremap(0xFE200034,GPIO_SIZE);
    return 0;
}
